...
/*   Updated: 2021/03/24 14:40:49 by akasha           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
typedef struct	s_exe_info
{
	...
	int					(*operator_exe_function)(char **args, char *next_arg, int (*exe_function)(t_exe_args *), t_exe_args fun_args, int operators_flag);
	char				*args;
...
typedef struct	s_support_parsing_data
{
	...
	int			(*operators_exe_func_arr[5])(char **args, char *next_arg, int (*exe_function)(t_exe_args *), t_exe_args fun_args, int operators_flag);
