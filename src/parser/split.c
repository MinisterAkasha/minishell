...
//int main()
//{
//      char *str = "echo ch'l'en;bin;ls ;'e'c'h'o pam> ty't'y ;e'ch'o 111'111'| cd papka ; echo \"222\"222 >> 'echo' \"333333\" ; echo {HOME} ; echo {HOME   } ; echo ${HOME   }fad ; echo ${HOME   } ;     echo    '' | echo 44'44'44 ; echo some_word > test.txt test test ; echo next_word > extra_test.txt extra extra ";
//      char **splited_str;
//      int i;
//
//      i = 0;
